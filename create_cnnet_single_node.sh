...
sudo ip netns exec l2h1 ethtool -K eth0 rxvlan off txvlan off
...
sudo ip netns exec l2h2 ethtool -K eth0 rxvlan off txvlan off

## Setup related configuration in loxilight for vlan100 to connect l2h1 and l2h2
...
## Create two hosts l2vxh1 and l2vxh2 which communicate with vxlan over loxilight namespace
## This vxlan will connect these two hosts which are in the same subnet.
...
## Create two hosts l3vxh1 and l3vxh2 which communicate with vxlan over loxilight namespace
## These hosts will be in different subnets and there will be routing on top  of vxlan for proper communication
...
## Create pin directory for loxilight maps
